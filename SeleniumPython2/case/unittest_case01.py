...
class RegisterBusiness(unittest.TestCase):
    ...
    def get_code_image(self):
        self.driver.save_screenshot("C:/Users/xx/Desktop/SeleniumPython2/register/test01.png")
        code_element = self.driver.find_element_by_id("getcode_num")
        left = code_element.location['x']
        top = code_element.location['y']
        right = code_element.size['width'] + left
        height = code_element.size['height'] + top
        im = Image.open("C:/Users/xx/Desktop/SeleniumPython2/register/test01.png")
        box = [left, top, right, height]
        region = im.crop(box)
        region.save("C:/Users/xx/Desktop/SeleniumPython2/register/test01.png")
    ...
    def code_online(self):
        ...
        r.addFilePara("image", "C:/Users/xx/Desktop/SeleniumPython2/register/test01.png")
        res = r.post()
